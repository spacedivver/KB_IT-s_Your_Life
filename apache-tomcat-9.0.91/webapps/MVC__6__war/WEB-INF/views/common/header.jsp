...
<div id="container">
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/service/allAllowService.do">권한 있는 서비스</a></li>
                    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/service/userNotAllowService.do">권한 없는 서비스</a></li>
			    </ul>
	...
	<section id="content">
		...
		credentials : <sec:authentication property="credentials"/> (안보이는게 정상) <br />
