...
<section id="content">
	...
	<div id="enroll-container">
		<form name="membebUpdateFrm" action="<%=request.getContextPath()%>/member/update" method="post">
			<table>
				<tr>
					<th>아이디</th>
					<td>
						<input type="text" name="userId" id="userId" readonly value="<%=member.getId()%>"/>
					</td>
				</tr>
				<tr>
					<th>이름</th>
				...
				<tr>
					<th>이메일</th>
					<td>
						<input type="email"	name="email" placeholder="test@email.com" value="<%=member.getEmail()%>">
					</td>
				</tr>
				<tr>
					<th>주소</th>
				...
				<tr>
					...
					<td>
						...
						<label><input type="checkbox" name="hobby" value="여행"
									<%=hobbies.contains("여행") ? "checked" : ""%>/>여행</label>
					</td>
				</tr>
			</table>
