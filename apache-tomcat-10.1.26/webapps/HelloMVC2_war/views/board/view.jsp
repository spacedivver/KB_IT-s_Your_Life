<%@page import="com.multi.mvc.board.model.vo.Reply"%>
...
<%
	...
	String fileReName = board.getRenamedFilename();
%>
	...
	<div id='board-write-container'>
		...
		<table id='tbl-board'>
			...
			<tr>
				...
				<td>
					<%if(fileName != null && fileName.length() > 0 && 
								(fileName.contains(".jpg") || fileName.contains(".png") || fileName.contains(".jpeg"))) { %>
