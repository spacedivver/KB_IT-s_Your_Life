...
<section id="content">
	<h3 align="center">회원정보 보기(Update)</h3>
	...
	<form id="enroll-container" name="form1" action="${path}/member/update" method="post">
		<table>
			<tr>
				<th>아이디</th>
				<td>
					<input type="text" id="id" name="id" value="${loginMember.id}"  required readonly>
				</td>
			</tr>		
			<tr>
				<th>이름</th>
			...
			<tr>
				<th>전화번호</th>
				<td>
					<input type="tel" id="phone" name="phone" maxlength="13" value="${loginMember.phone}" placeholder="010-1234-5678">
				</td>
			</tr>
			<tr>
				<th>이메일</th>
