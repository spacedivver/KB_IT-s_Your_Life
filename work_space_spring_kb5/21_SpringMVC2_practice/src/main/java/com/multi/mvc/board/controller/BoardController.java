...
public class BoardController {
    ...
    // list, view, write, write, update, update, delete
    // list, viewBoard, writePage, write, update, update, delete
    // get, get, get, get, post, get, request
    ...
    @PostMapping("/write")
    public String wrtie(Board board){
