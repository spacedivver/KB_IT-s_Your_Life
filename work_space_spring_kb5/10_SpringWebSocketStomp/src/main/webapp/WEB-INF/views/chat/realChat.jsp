...
<head>
    ...
    <script type="text/javascript" src="${path}/resources/js/webSocketSendToUserApp.js"></script>
</head>
...
<div class="container">
    <div class="input-group mb-3 input-group">
        ...
        <input type="text" class="form-control" id="from" value="${sessionScope.member.memberId}">
    </div>
    <div>
    ...
    <div id="conversationDiv">
        <div class="input-group" >
            ...
            <button id="sendMessage" onclick="sendMessage();" type="button"
                    class="btn btn-primary input-group-btn">Send
            </button>
        </div>
        <div id="response" class="alert alert-success mt-3"></div>
    </div>
</div>
</body>
</html>
...
<script type="text/javascript">
    ...
    function connect() {
        //1. 소켓객체 생성
        var socket = new SockJS('${path}/chat')
