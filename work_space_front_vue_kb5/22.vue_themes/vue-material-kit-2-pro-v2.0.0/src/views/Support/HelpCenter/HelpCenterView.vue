...
//sections
import HelpCenterSocialAnalytics from "./Sections/HelpCenterSocialAnalytics.vue";
import Faq from "./Sections/HelpCenterFaq.vue";
import Features from "./Sections/HelpCenterFeatures.vue";
import Contact from "./Sections/HelpCenterContact.vue";
</script>
<template>
  <DefaultNavbar transparent />
  <Header
    :image="image"
    :title="{ variant: 'h2', text: 'How can we help you?' }"
    mask="mask bg-gradient-dark opacity-6"
    minHeight="min-vh-50"
    center
  >
    <MaterialButton variant="gradient" color="success" class="mb-0 mx-auto"
      >Search issue</MaterialButton
    >
  </Header>
  <div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
    <HelpCenterSocialAnalytics />
    <Faq />
    <Features />
    <Contact />
  </div>
    ...
    <div class="container position-relative z-index-1">
      <div class="row">
        ...
        <div class="col-lg-6 ms-auto text-lg-end text-center">
          <p class="mb-5 text-dark opacity-8 font-weight-bold">
